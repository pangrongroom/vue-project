  ...
  <div>
    ...
    <el-card class="box-card">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="4">
          <el-button type="primary" @click="addDiaologVisible = true"
            >添加用户</el-button
          >
        </el-col>
      </el-row>
...
export default {
  ...
  data() {
    //验证邮箱的效验规则
    var checkEmail = (rule, value, cbck) => {
      //正则表达式
      const regEmail =
      ...
      //不合法
      cbck(new Error("请输入合法的邮箱"));
    };
    //验证手机号的效验规则
    var checkMobile = (rule, value, cbck) => {
      //正则表达式
      const regMobile =
