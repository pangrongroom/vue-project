    ...
    <el-container>
      <el-header>
        <el-header>
          <el-row>
            <el-col :span="8">
              <div class="grid-content bg-purple"><img class="nav_logo" src="../assets/logo.png" style="width: 60px" /></div>
            </el-col>
            <el-col :span="8">
              <div class="grid-content bg-purple-light">这是密码重置页面</div>
            </el-col>
            <el-col :span="8">
      ...
      <el-main>
        <div class="user_logon_develop_ym">
          <div style="font-size: 35px">密码重置</div>
          <el-form :model="ruleForm" status-icon :rules="rules" ref="ruleForm" label-width="100px">
            ...
            <el-form-item label=" 确认密码 : " prop="checkPass">
              <el-input type="password" v-model="ruleForm.checkPass" placeholder="请再输入一遍密码:" autocomplete="off"></el-input>
            </el-form-item>
            <el-form-item label=" 手 机 号 : " prop="userPhone">
              <el-input type="text" v-model.number="ruleForm.userPhone" placeholder="手机号:"></el-input>
            </el-form-item>
